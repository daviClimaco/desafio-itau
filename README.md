> Projeto desenvolvido como parte dos meus estudos em Java, Spring Boot e APIs REST. A implementação foi concluída com o auxílio de um tutorial, com foco no aprendizado dos conceitos e boas práticas da tecnologia.
